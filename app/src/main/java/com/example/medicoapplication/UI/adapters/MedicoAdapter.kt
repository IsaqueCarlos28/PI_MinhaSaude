...
class MedicoAdapter(
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tvEspecialidade: TextView = itemView.findViewById(R.id.tvEspecialidadeMedico)
        val btnSelecionar: Button = itemView.findViewById(R.id.btnSelecionarMedico)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnSelecionar.setOnClickListener { onSelecionar(medico) }
    }
