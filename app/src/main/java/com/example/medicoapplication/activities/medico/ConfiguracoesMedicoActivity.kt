...
class ConfiguracoesMedicoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<LinearLayout>(R.id.itemNotificacoesMedico).setOnClickListener {
            startActivity(Intent(this, com.example.medicoapplication.activities.auth_e_cadastro.LoginActivity::class.java))
        }

        // Encerrar sessão
        findViewById<android.widget.Button>(R.id.btnEncerrarSessaoMedico).setOnClickListener {
