...
class AgendaMedicoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Navegação mês
        findViewById<android.widget.ImageView>(R.id.btnMesAnterior).setOnClickListener {
            calAtual.add(Calendar.MONTH, -1)
            atualizarCalendario()
        }
        findViewById<android.widget.ImageView>(R.id.btnProximoMes).setOnClickListener {
            calAtual.add(Calendar.MONTH, 1)
            atualizarCalendario()
        }
        ...
        return TextView(this).apply {
            ...
            when {
                selecionado -> {
                    ...
                    backgroundTintList = android.content.res.ColorStateList.valueOf(0xFF3B82F6.toInt())
